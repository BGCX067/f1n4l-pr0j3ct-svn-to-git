var total_items = 0;
    ...
    $(document).ready(function() {
        ...
        $("#cart_items").droppable({
            ...
            drop: function(event, ui) {
                ...
                // update total price
                var price = parseFloat(ui.draggable.find(".price").html().replace("R$ ", ""));
                total_price = total_price + price;
				total_price =((Math.round(total_price*100))/100);  

				
				$("#cprice").html("R$ " + total_price);
    ...
    function remove(el) {
        ...
        total_price = total_price - 10; /*OBS ele nao pega o valor do price, mas a conta funciona*/
